...
// Convert cubic bezier array to an easing function
const cubicBezier = (p1: number, p2: number, p3: number, p4: number) => {
  return (t: number) => {
    if (t <= 0) return 0;
    if (t >= 1) return 1;
...
// Define the easing function for easeOutCubic
const EASE_OUT_CUBIC = cubicBezier(0.33, 1, 0.68, 1);
        ...
        >
          ...
          <h2 className="font-serif text-3xl md:text-5xl mb-4 relative">
            <SplitText
              ...
              delay={30}
              easing={EASE_OUT_CUBIC} // Use the easing function
            />
            <SplitText
              text="Properties"
